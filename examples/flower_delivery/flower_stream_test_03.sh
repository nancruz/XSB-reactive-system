...
load_database('../examples/flower_delivery/use_cases/flower_stream_test_03.db'), 
execute_event_stream_file('../examples/flower_delivery/use_cases/flower_stream_test_03.stream')."
################################################################################
rm -rf *.bin *.ctr