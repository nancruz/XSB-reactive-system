...
load_database('../examples/flower_delivery/use_cases/flower_stream_test_02.db'), 
execute_event_stream_file('../examples/flower_delivery/use_cases/flower_stream_test_02.stream')."
################################################################################
rm -rf *.bin *.ctr