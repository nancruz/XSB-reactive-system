...
load_database('../examples/flower_delivery/use_cases/flower_stream_test_01.db'), 
execute_event_stream_file('../examples/flower_delivery/use_cases/flower_stream_test_01.stream')."
################################################################################
rm -rf *.bin *.ctr